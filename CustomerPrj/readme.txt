...
Directory wwwroot/auto_update.html is to simulate http post ( requirements 1 ) automatically by opening the url
...
But SortedList prevails by utilizing cpu cache well ( in additon to its less memory usage ).
